...
public class ViewAnnouncementLoader {
	// This is the controller class that works with the FXML "GUI_Login.fxml".
	private ViewAnnouncementController controller;

	// The JavaFX FXMLLoader class is used to loading FXML files at runtime.
	final private FXMLLoader FXML_Loader = new FXMLLoader(getClass().getResource("GUI_ViewAnnouncement.fxml"));
	...
	public void start(Stage arg0, Announcement arg1, AccountController arg2) throws IOException {
		this.myStage = arg0; 
		...
		try {
			...
			myStage.setTitle("Announcement Viewer");
