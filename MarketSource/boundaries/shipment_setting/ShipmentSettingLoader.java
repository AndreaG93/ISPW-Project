...
public class ShipmentSettingLoader {

	// This is the controller class that works with the FXML
	// "GUI_ShipmentSetting.fxml".
	private ShipmentSettingController controller;

	// The JavaFX FXMLLoader class is used to loading FXML files at runtime.
	final private FXMLLoader FXML_Loader = new FXMLLoader(getClass().getResource("GUI_ShipmentSetting.fxml"));
