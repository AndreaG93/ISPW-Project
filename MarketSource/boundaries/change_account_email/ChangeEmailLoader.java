...
public class ChangeEmailLoader {
	...
	final private FXMLLoader FXML_Loader = new FXMLLoader(getClass().getResource("GUI_ChangeEmail.fxml"));
	...
	public void start(Stage arg0, AccountController arg1) throws IOException {
		...
		try {
			...
			myStage.setTitle("Change your email");
