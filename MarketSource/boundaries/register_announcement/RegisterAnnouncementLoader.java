...
public class RegisterAnnouncementLoader {
	// This is the controller class that works with the FXML.
	private RegisterAnnouncementController controller;

	// The JavaFX FXMLLoader class is used to loading FXML files at runtime.
	final private FXMLLoader FXML_Loader = new FXMLLoader(getClass().getResource("GUI_RegisterAnnouncement.fxml"));
	...
	public void start(Stage arg0, AccountController arg1) throws IOException {
		...
		try {
			...
			myStage.setTitle("Register a new Announcement");
